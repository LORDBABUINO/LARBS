...
# DEFAULTS:
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/LORDBABUINO/voidrice.git"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/LORDBABUINO/LARBS/master/progs.csv"
...
putgitrepo() { # Downlods a gitrepo $1 and places the files in $2 only overwriting conflicts
	...
	chown -R "$name:wheel" "$dir"
 	sudo -u "$name" git clone --depth 1 --recurse-submodules "$1" "$dir/gitrepo" >/dev/null 2>&1 &&
...
# Make user use docker without password
